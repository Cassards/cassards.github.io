...
void display()
{
	...
	///////////////////////////////////////////////////////////////////////////
	glBindFramebuffer(GL_FRAMEBUFFER, 2); // to be replaced with another framebuffer when doing post processing
	glViewport(0, 0, w, h);
	glClearColor(0.2, 0.2, 0.8, 1.0);
	glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
    ...
    glBindTexture(GL_TEXTURE_2D, postProdFB.colorTextureTarget);
...
void gui()
{
	...
	ImGui::SameLine();
	ImGui::SliderInt("Mosaic size", &mosaicSize, 2, 32);
